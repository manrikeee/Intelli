...
echo '<table class="tabla table-striped">';
                            ...
                            $query = "SELECT pedido_producto.* ,precio FROM pedido_producto,producto where pedido_producto.id_producto=producto.id and pedido_producto.estado=1 and (producto.tipo='Carne' or producto.tipo='Pescado')ORDER BY pedido_producto.id ASC" ;
